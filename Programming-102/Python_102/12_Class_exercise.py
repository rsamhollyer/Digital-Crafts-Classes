...
class Motorcycle(Vehicle):
    def __init__(self, category, wheels, speed, top_speed, position, acceleration, turbo):
        super().__init__(category, wheels, speed, top_speed, position, acceleration)
        self.turbo = turbo
...
sport = Motorcycle("Bike A", 2,15,150,0,10,9)
# sport2 = Motorcycle()
print(sport.turbo)
# print(sport2.turbo)